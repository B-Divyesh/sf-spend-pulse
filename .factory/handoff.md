...
- Live demo clear at `/settings?demo=1`: HTTP 200 and exact visible result **“All demo data cleared.”** A separate fresh real-data context also asserted **“All local data cleared.”** Evidence: `.factory/polish-4-artifacts/demo-clear-mobile-390.png`.
