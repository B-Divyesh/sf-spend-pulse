...
- Exit: press “Start for real”, use the Spend Pulse wordmark, or follow a non-demo navigation link. Each exit discards demo data. Existing real data remains unchanged.
